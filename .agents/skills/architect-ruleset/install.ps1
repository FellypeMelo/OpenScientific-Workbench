# install.ps1
# Script to install the architect-ruleset skill in Antigravity/Gemini (Global or Local)
...
Write-Host "architect-ruleset skill installed successfully!" -ForegroundColor Green
